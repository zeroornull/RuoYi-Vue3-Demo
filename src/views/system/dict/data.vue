...
<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5"><el-button v-hasPermi="['system:dict:export']" type="warning" plain :icon="Download" @click="download('system/dict/data/export', { ...queryParams }, `dict_data_${Date.now()}.xlsx`)">导出</el-button></el-col>
      <RightToolbar v-model:show-search="showSearch" @query-table="getList" />
    </el-row>
    <el-table v-loading="loading" :data="list" @selection-change="(rows: DictData[]) => (selection = selectionFromRows(rows, (row) => row.dictCode))">
