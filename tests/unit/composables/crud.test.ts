...
describe("CRUD selection and paging helpers", () => {
  ...
  test("resolves a row id or the current selection and formats delete copy", () => {
    ...
    expect(confirmDeleteMessage("参数", "1,2")).toBe(
      '是否确认删除参数编号为"1,2"的数据项？',
    );
  });
